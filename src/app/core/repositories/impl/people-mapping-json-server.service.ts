  ...
  export class PeopleMappingJsonServer implements IBaseMapping<Person> {
    ...
    getOne(data: PersonRaw):Person {
        return {
            ...
            age:(data as any)["age"]??0, //Doble interrogacion es un ternario pero solo cno dos campos, devuelve lo primero si no devuelve lo segundo, asi no hay que hacer tres opciones
